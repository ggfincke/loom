...
def build_generate_prompt(job_info: str,
    ...
    base_prompt += (
        ...
        "{\n"
        "  \"version\": 1,\n"
        "  \"meta\": { \"strategy\": \"rule\", \"model\": \"gpt-4\", \"created_at\": \"2024-01-01T12:00:00Z\" },\n"
        "  \"ops\": [\n"
...
def build_edit_prompt(job_info: str,
    ...
    base_prompt += (
        ...
        "{\n"
        "  \"version\": 1,\n"
        "  \"meta\": { \"strategy\": \"edit_fix\", \"model\": \"gpt-4\", \"created_at\": \"2024-01-01T12:00:00Z\" },\n"
        "  \"ops\": [\n"
...
def build_prompt_operation_prompt(user_instruction: str,
    ...
    base_prompt += (
        ...
        "{\n"
        "  \"version\": 1,\n"
        "  \"meta\": { \"strategy\": \"prompt_regeneration\", \"model\": \"gpt-4\", \"created_at\": \"2024-01-01T12:00:00Z\" },\n"
        "  \"ops\": [\n"
