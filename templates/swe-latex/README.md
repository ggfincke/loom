...
templates/
└── swe-latex/
    ├── loom-template.toml      # Loom descriptor
...
Copy this `swe-latex` directory to your working location (the trailing `/.` avoids nesting):

```bash
cp -r templates/swe-latex/. my-resume
cd my-resume/
```
