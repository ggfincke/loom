...
def create_basic_formatted_resume():
    ...
    doc.add_paragraph("Experienced software engineer w/ 5+ years developing web applications using modern frameworks & technologies.")
    ...
    doc.add_paragraph("• Developed & maintained microservices architecture serving 500K+ users")
