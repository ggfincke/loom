...
from src.core.exceptions import (
    LoomError, ValidationError, AIError, EditError, ConfigurationError, 
    JSONParsingError, LaTeXError, handle_loom_error
)
...
class TestHandleLoomErrorDecorator:
    ...
    @pytest.mark.parametrize("exception_class,expected_error_type", [
    ...
    def test_specific_loom_errors(self, mock_console, exception_class, expected_error_type):
        @handle_loom_error
